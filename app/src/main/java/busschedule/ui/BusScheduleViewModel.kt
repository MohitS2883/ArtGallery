...
import busschedule.BusApplication
import busschedule.data.BusSchedule
import busschedule.data.ScheduleDao
...
class BusScheduleViewModel(private val busScheduleDao: ScheduleDao) : ViewModel() {
    ...
    fun getScheduleFor(stopName: String): Flow<List<BusSchedule>> = busScheduleDao.getStop(stopName)
