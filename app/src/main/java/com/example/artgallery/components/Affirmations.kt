...
import com.example.artgallery.data.AffirmationDataSource
import com.example.artgallery.model.Affirmation
...
private fun AffirmationCardPreview() {
    val affirm: Affirmation = Affirmation(R.string.affirmation1, R.drawable.image1)
